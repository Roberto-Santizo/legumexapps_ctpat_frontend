...
import CtpatTruckDriverAssignmentForm from "../components/forms/CtpatTruckDriverAssignmentForm";
import type { CreateCtpatAssignmentForm } from "../components/forms/CtpatTruckDriverAssignmentForm";
...
export default function CreateCtpatAssignment({ ctpatId }: { ctpatId: number }) {
  ...
  const { mutate } = useMutation({
    ...
    onSuccess: (response) => {
      ...
      updateStatus.mutate({ id: ctpatId, status: 4 });
      navigate("/ctpats");
    },
