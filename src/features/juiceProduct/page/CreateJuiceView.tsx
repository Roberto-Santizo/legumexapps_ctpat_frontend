...
import { juiceCreateAPI } from "@/features/juiceProduct/api/JuiceApi";
import CreateJuiceForm from "features/juiceProduct/component/CreateJuiceForm";




export default function CreateJuiceView() {
  ...
  const handleForm = (formData : JuiceSchemaFormData) =>mutate(formData);
    ...
    <div className="min-h-screen bg-[var(--color-bg-primary)] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-6 text-center text-sm text-[var(--color-text-tertiary)]">
          <p>Los cambios se aplicarán inmediatamente después de crear el jugo</p>
        </div>
      </div>
    </div>
  );
